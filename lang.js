(function () {
  ...
  var T = {
    ...
    'hero.heading':  { de: 'Praxis für Faszien &amp; <em>Triggerpunkte</em> in Spaichingen', en: 'Practice for Fascia &amp; <em>Trigger Points</em> in Spaichingen', es: 'Centro de terapia de <em>fascia y puntos gatillo</em> en Spaichingen', it: 'Studio di terapia fascia &amp; <em>trigger point</em> a Spaichingen', ru: 'Кабинет фасциальной &amp; <em>триггерной терапии</em> в Шпайхингене', fr: 'Cabinet de thérapie des <em>fascias &amp; points gâchette</em> à Spaichingen' },
